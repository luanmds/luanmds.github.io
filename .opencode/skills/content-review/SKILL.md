...
- Mirrors PT-BR catchphrases: "Enjoy the read!" → "Boa leitura!", "This is all Folks…" → "Isso é tudo pessoal…"
...
| Section | Notes |
|---|---|
| **Intro paragraph** | States what the article covers + why it matters in bold + "Boa leitura!" (PT) or "Enjoy the read!" (EN) |
...
| **Conclusion** | Header "Isso é tudo pessoal…" (PT) / "This is all Folks…" (EN) — wraps up, points to repo, asks for feedback |
...
- [ ] Is there a "Boa leitura!" or "Enjoy the read!" opening?
- [ ] Does the conclusion ask for feedback / invite community interaction?
...
5. If the user asks to apply fixes: edit the draft directly, preserving everything that's already working.
...
| Missing "Boa leitura!" | Intro jumps straight to content | Add after the intro paragraph |
| No conclusion CTA | Article just stops after last section | Add "Isso é tudo pessoal…" section with feedback ask |
...
Key elements: compiled overview → specific sub-topics → **bold practical impact statement** → "Boa leitura!"
